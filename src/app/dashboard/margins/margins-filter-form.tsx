...
const FILTER_FIELDS = ["from", "to", "product", "bill"] as const;

export function MarginsFilterForm({
  view,
  from,
  to,
  product,
  ...
  return (
    <form ref={formRef} method="get" action="/dashboard/margins" className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
